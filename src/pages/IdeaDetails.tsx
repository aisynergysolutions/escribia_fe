      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-lg border">
                  <div className="flex justify-between items-center p-4 border-b">
                    ...
                    <div className="flex gap-2">
                      <VersionHistory versions={versionHistory} onRestore={handleRestoreVersion} />
              ...
              <TabsContent value="hooks" className="pt-4">
                <div className="bg-white rounded-lg border p-4">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <Button onClick={handleRegenerateHooks} className="bg-indigo-600 hover:bg-indigo-700">
                      Regenerate Hooks
                    </Button>
                  </div>
                  <div className="space-y-4">
                    {idea?.generatedHooks?.map((hook, index) => <div key={index} className={`p-3 rounded-md border cursor-pointer ${selectedHookIndex === index ? 'border-indigo-500 bg-indigo-50' : 'hover:bg-gray-50'}`} onClick={() => handleHookSelect(index)}>
                        <div className="flex justify-between">
                          <p>{hook.text}</p>
                          {selectedHookIndex === index ? <Badge className="bg-indigo-600">Selected</Badge> : <Button variant="outline" size="sm" onClick={e => {
                        e.stopPropagation();
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  {predefinedStatuses.map(s => <DropdownMenuItem key={s} onClick={() => setStatus(s)}>
                      {s}
                    </DropdownMenuItem>)}
                  <CustomInputModal title="Add Custom Status" placeholder="Enter custom status..." onSave={handleAddCustomStatus}>
                    <DropdownMenuItem onSelect={e => e.preventDefault()}>
                      Add custom status...
                    </DropdownMenuItem>
                  </CustomInputModal>
          ...
          <Card className="p-6">
            ...
            <div className="border-2 border-dashed rounded-lg p-6 text-center" onDrop={handleFileDrop} onDragOver={handleDragOver}>
          ...
          <Card className="p-6">
            ...
            <div className="flex items-center space-x-2 mb-4">
              <input type="checkbox" id="training-data" checked={useAsTrainingData} onChange={e => setUseAsTrainingData(e.target.checked)} className="rounded border-gray-300" />
            ...
            <div>
              ...
              <Textarea id="internalNotes" value={internalNotes} onChange={e => setInternalNotes(e.target.value)} placeholder="Add internal notes here (not visible to clients)..." rows={3} />
            </div>
          </Card>
        </div>
      </div>
