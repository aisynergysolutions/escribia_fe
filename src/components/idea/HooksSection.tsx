...
const HooksSection: React.FC<HooksSectionProps> = ({
  ...
  return <div className="bg-card rounded-lg border p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Button onClick={handleRegenerateClick} variant="outline" disabled={isRegenerating} className="text-xs">
      ...
      <div className="space-y-3">
        ...
        return <div key={index}>
            <button onClick={() => handleHookClick(index)} disabled={isLoading || isRegenerating} className={`w-full p-3 rounded-md border text-left transition-all 
