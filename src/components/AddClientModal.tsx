  ...
  return <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-6">
          {/* Instructional Text */}
          <p className="text-gray-600 leading-relaxed">Use the unique onboarding link below. You can complete the form on your client's behalf or copy the link and send it to them to fill out.</p>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input value={tallyUrl} readOnly className="pr-32 bg-gray-50 border-gray-200 text-gray-700 cursor-default" />
              <Button type="button" variant="secondary" size="sm" onClick={handleCopyLink} className="absolute right-2 top-1/2 transform -translate-y-1/2 h-7 px-3">
                {copied ? <>
