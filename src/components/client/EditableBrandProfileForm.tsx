...
const EditableBrandProfileForm: React.FC<EditableBrandProfileFormProps> = ({ client, onSave, onCancel }) => {
      ...
      <CardContent>
        <Accordion type="multiple" className="w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-2">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, locationFocus: e.target.value }))}
                    className="mt-1"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, sellsWhat: e.target.value }))}
                    className="mt-1"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, sellsToWhom: e.target.value }))}
                    className="mt-1"
                  />
                </div>
                <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, emojiUsage: e.target.value }))}
                      className="mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      id="desiredPostLength"
                      value={formData.desiredPostLength}
                      onChange={(e) => setFormData(prev => ({ ...prev, desiredPostLength: e.target.value }))}
                      className="mt-1"
                    />
                  </div>
                </div>
          ...
          <AccordionItem value="aiInstructions">
            <AccordionTrigger className="text-base font-medium">AI Instructions</AccordionTrigger>
            <AccordionContent>
              <div className="space-y-4 py-2">
                <div>
                  ...
                  <Textarea
                    id="customInstructionsAI"
                    value={formData.customInstructionsAI}
                    onChange={(e) => setFormData(prev => ({ ...prev, customInstructionsAI: e.target.value }))}
                    placeholder="Enter custom instructions for AI content generation"
                    className="mt-1 h-32"
                  />
                </div>
              </div>
