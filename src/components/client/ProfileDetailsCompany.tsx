...
import { Linkedin, Building2, MapPin, Calendar, ExternalLink } from 'lucide-react';
...
const ProfileDetailsCompany: React.FC = () => {
  ...
  useEffect(() => {
    if (clientId && profileId) {
      getCompanyProfile(clientId, profileId).then(setProfile);
    }
  }, [clientId, profileId]);
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <div className="mb-2">
                <span className="font-medium">Company Name:</span> {profile.profileName}
              </div>
              <div className="mb-2">
              ...
              <div className="mb-2 flex items-center gap-2">
                ...
                <span className="font-medium">Founded:</span> {profile.foundationDate || 'N/A'}
              </div>
              <div className="mb-2 flex items-center gap-2">
            ...
            <div>
              <div className="mb-2">
                ...
                <a
                  href={`https://linkedin.com/company/${linkedin.linkedinName}`}
                  target="_blank"
              ...
              <div className="mb-2">
                <span className="font-medium">Onboarding Link:</span>
                <a
